...
document.querySelector("#btn-traduce").addEventListener("click", () => {
  ...
  document.querySelector("#header-text").innerText =
    "More than 4 years of experience in web development and design, complemented by other related knowledge";
  ...
  document.querySelector("#container-about-me-info > p").innerHTML =
      `My name is <strong>Nicolás Martín Agüero</strong>, I am 18 years old and I live in Buenos Aires (CABA), <strong>Argentina</strong>. I like programming, designing, making music and creating. I graduated as a <strong>Higher Technician in Web Design and Web Programming</strong> at the "<strong><a class='hvr-skew'
    target = '_blank' href = 'https://davinci.edu.ar/carreras/desarrollo-web-y-mobile' > Escuela Da Vinci</a ></strong >".`;

  document.querySelector(
    "#container-about-me-info > button"
  ).innerHTML = `                
  ...
  document.querySelector("#header-text").innerText =
    "Más de 4 años de experiencia en desarrollo y diseño web, complementado con otros conocimientos relacionados";
  ...
  document.querySelector("#container-about-me-info > p").innerHTML =
    `Mi nombre es Nicolás Martín Agüero, tengo 18 años y vivo en Buenos Aires (CABA), Argentina. Me gusta programar, diseñar, hacer música y crear. Mi nombre es <strong>Nicolás Martín Agüero</strong>, tengo 18 años y vivo en Buenos Aires (CABA),
    <strong>Argentina</strong>. Me gusta programar, diseñar, hacer música y crear.<br>
    Me recibí en <strong>Técnico Superior en Diseño y Programación Web</strong> web en la "<strong><a class="hvr-skew" target="_blank" href="https://davinci.edu.ar/carreras/desarrollo-web-y-mobile">Escuela Da Vinci</a></strong>".`;
